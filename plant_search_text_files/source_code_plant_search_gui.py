...
layout = [
    ...
    [sg.Text('Do you want to search over all plant genera (enter 1) \n'
    ...
    [sg.Output(size=(80, 8), key='-OUTPUT-')],
    
    # add checkbox
    [sg.Checkbox('Open saved_search txt output folder when finished', default=True, key='-OPENFI-')],
...
if checkedfi == True:
    ...
    # #Ask the user whether to perform another search or not
    # search_again = sg.popup_yes_no('Do you want to perform another search?')
    # # continue the loop if the user wants to perform another search
    # if search_again == 'Yes':
    #     continue
    # # break the loop if the user doesn't want to perform another search
    # else:
    #     break
